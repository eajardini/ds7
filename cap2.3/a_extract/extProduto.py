# cap2.3/a_extract/extProduto.py
...
query = """
    SELECT codigo_produto , unidade , descricao , valor_venda , valor_custo , qtde_minima , quantidade , 
    comissao_produto 
    FROM produto;
"""
...
def executeExtract():
    ...
    """
    try:
        print(f"Etapa: Extraindo Produtos")
        ...
        print(f"[extProduto.py|executeExtract] Ocorreu um erro: {e}")
        return None
